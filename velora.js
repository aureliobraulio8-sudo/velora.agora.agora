...
const TRANSLATIONS = {
  pt: {
    ...
    chip_4_msg: 'Quais são as maiores tendências de conteúdo digital em 2025?',
  ...
  en: {
    ...
    chip_4_msg: 'What are the biggest digital content trends in 2025?',
  ...
  es: {
    ...
    chip_4_msg: '¿Cuáles son las mayores tendencias de contenido digital en 2025?',
    velora_label: 'VELORA IA',
